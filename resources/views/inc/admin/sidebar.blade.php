      ...
      <div class="navbar-vertical-content scrollbar">
        <ul class="navbar-nav flex-column" id="navbarVerticalNav">
            ...
            <li class="nav-item"><a class="nav-link active" href="/admin/products">
                <div class="d-flex align-items-center"><span class="nav-link-icon"><span data-feather="shopping-cart"></span></span><span class="nav-link-text">Products</span></div></a>
              </li>
          <li class="nav-item">
            ...
            <ul class="nav collapse parent" id="e-commerce">
              <li class="nav-item"><a class="nav-link" href="apps/e-commerce/products.html" data-bs-toggle="" aria-expanded="false">
          ...
          <li class="nav-item">
            ...
            </a><a class="nav-link dropdown-indicator" href="#pages" role="button" data-bs-toggle="collapse" aria-expanded="false" aria-controls="pages">
              <div class="d-flex align-items-center">
                <div class="dropdown-indicator-icon d-flex flex-center"><span class="fas fa-caret-right fs-0"></span></div><span class="nav-link-icon"><span data-feather="layout"></span></span><span class="nav-link-text">Pages</span>
              </div>
            </a>
            <ul class="nav collapse parent" id="pages">
              <li class="nav-item"><a class="nav-link" href="pages/pages/faq-accordion.html" data-bs-toggle="" aria-expanded="false">
                  <div class="d-flex align-items-center"><span class="nav-link-text">Faq accordion</span></div>
                </a></li>
              <li class="nav-item"><a class="nav-link" href="pages/pages/pricing.html" data-bs-toggle="" aria-expanded="false">
                  <div class="d-flex align-items-center"><span class="nav-link-text">Pricing</span></div>
                </a></li>
              <li class="nav-item"><a class="nav-link" href="pages/pages/notifications.html" data-bs-toggle="" aria-expanded="false">
                  <div class="d-flex align-items-center"><span class="nav-link-text">Notifications</span></div>
                </a></li>
              <li class="nav-item"><a class="nav-link" href="pages/pages/members.html" data-bs-toggle="" aria-expanded="false">
                  <div class="d-flex align-items-center"><span class="nav-link-text">Members</span></div>
                </a></li>
            </ul><a class="nav-link dropdown-indicator" href="#errors" role="button" data-bs-toggle="collapse" aria-expanded="false" aria-controls="errors">
              <div class="d-flex align-items-center">
